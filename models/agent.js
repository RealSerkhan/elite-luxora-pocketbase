import { generateImageUrl, generateImageUrls } from '../utils/image_helper.js';
...
class Agent extends BaseModel {
    constructor(data, lang = 'en') {
        ...
        this.areas = data.expand?.area_ids?.map(area => new Area(area, lang)) ;
        ...
        this.awards = generateImageUrls(data.collectionId, data.id, data.awards);
